...
Partial Class edit_service
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        '    TextBox4.Focus()
        'End If
        Response.Redirect("edit_Summary.aspx?request_id=" + xRequest_id)
    End Sub
End Class
